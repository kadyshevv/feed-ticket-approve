var hlghtta = function (b, t, re, c) {
  ...
  function styleDiv(n) {
    n.style.boxSizing = tComp.getPropertyValue("box-sizing");
    n.style.fontStyle = tComp.getPropertyValue("font-style");
    n.style.fontSize = tComp.getPropertyValue("font-size");
    n.style.fontVariant = tComp.getPropertyValue("font-variant");
    n.style.fontWeight = tComp.getPropertyValue("font-weight");
    n.style.lineHeight = tComp.getPropertyValue("line-height");
    n.style.wordWrap = tComp.getPropertyValue("word-wrap");
    n.style.marginTop = tComp.getPropertyValue("margin-top");
    n.style.marginLeft = tComp.getPropertyValue("margin-left");
  }
